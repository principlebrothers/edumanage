...
**EDU MANAGER** is an to manage school operation and flow.The database designed is based on this schema ![Schema coming soon ...](https://)
...
**Note:** It is recommended you use the latest version of Ruby[3.2.2] and Rails[7.0]
...
Feel free to check the [issues page](https://github.com/principlebrothers/edumanage/issues/new).
